...
import jiguang.chat.pickerimage.adapter.ImagePagerAdapterInImageSwitch;
...
public class PreviewImageFromLocalActivity extends UIView {
	...
	private void sendOrigImage() {
		final UIView activity = PreviewImageFromLocalActivity.this;
