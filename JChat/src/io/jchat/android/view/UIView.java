...
import io.jchat.android.model.BaseFragment;
import io.jchat.android.model.ToolBarOptions;
import io.jchat.android.tools.ReflectionUtil;

public abstract class UIView extends FragmentActivity {
    ...
    public void setToolBar(int toolBarId, int goback, ToolBarOptions options) {
        toolbar = (TextView) findViewById(toolBarId);
        ImageView goBack = (ImageView) findViewById(goback);
        toolbar.setTextColor(Color.WHITE);
        if (options.titleId != 0) {
            toolbar.setText(options.titleId);
        }
        if (!TextUtils.isEmpty(options.titleString)) {
            toolbar.setText(options.titleString);
        }
