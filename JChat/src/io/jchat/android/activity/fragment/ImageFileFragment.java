...
import io.jchat.android.controller.HistoryFileController;
import io.jchat.android.entity.FileItem;
import io.jchat.android.entity.YMComparator;
            ...
            public void run() {
                ...
                for (cn.jpush.im.android.api.model.Message msg : allMessage) {
                    ...
                    if (content.getContentType() == ContentType.image) {
                        ...
                        System.out.println("=================" + localPath + "===" + imageContent.getLocalPath());
                        ...
                        if (!TextUtils.isEmpty(localPath)) {
                            ...
                            if (imageFile.exists()) {
                                ...
                                FileItem item = new FileItem(localPath, path, imageFile.getName(), size, time, msg.getId());
