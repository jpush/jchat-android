...
import io.jchat.android.adapter.PickerPreviewPagerAdapter;
...
import io.jchat.android.model.ToolBarOptions;
import io.jchat.android.tools.BitmapDecoder;
import io.jchat.android.tools.ImageUtil;
import io.jchat.android.tools.PickerUtil;
import io.jchat.android.tools.ToastUtil;
import io.jchat.android.tools.imagepicker.view.ViewPagerFixed;
...
public class PickerAlbumPreviewActivity extends UIView implements OnClickListener, OnPageChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setToolBar(R.id.picViewName, R.id.goBack, options);
    ...
    private void initActionBar() {
        View view = View.inflate(this, R.layout.action_bar_right_picker_preview, null);
        previewSelectBtn = (ImageButton) view.findViewById(R.id.picker_image_preview_photos_select);
