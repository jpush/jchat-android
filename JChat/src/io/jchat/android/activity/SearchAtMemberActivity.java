...
import io.jchat.android.model.SearchResult;
import io.jchat.android.tools.pinyin.CharacterParser;
import io.jchat.android.tools.pinyin.TextSearcher;
...
public class SearchAtMemberActivity extends BaseActivity implements View.OnClickListener {
    ...
    private SearchResult filterInfo(String filterStr) {
        ...
        //所有好友名单
        for (UserInfo friendInfo : JChatDemoApplication.mSearchAtMember) {
        ...
        mLv_searchGroup.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (itemAtPosition instanceof UserInfo) {
                    ...
                    intent.putExtra(JChatDemoApplication.SEARCH_AT_MEMBER_NAME, atName);
                    intent.putExtra(JChatDemoApplication.SEARCH_AT_MEMBER_USERNAME, userInfo.getUserName());
                    intent.putExtra(JChatDemoApplication.SEARCH_AT_APPKEY, userInfo.getAppKey());
                    setResult(JChatDemoApplication.SEARCH_AT_MEMBER_CODE, intent);
                    finish();
                }
            }
        });
