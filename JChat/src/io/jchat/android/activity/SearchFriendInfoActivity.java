...
public class SearchFriendInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        if (instance.getAvatarPath() != null) {
            mIv_photo.setImageBitmap(BitmapFactory.decodeFile(instance.getAvatarPath()));
        }else {
            mIv_photo.setImageResource(R.drawable.jmui_head_icon);
        }
