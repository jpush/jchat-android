...
import io.jchat.android.adapter.GroupGridViewAdapter;
    ...
    private void initData() {
        ...
        mGroup_gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position < mCurrentNum) {
                    ...
                    startActivityForResult(intent, JChatDemoApplication.REQUEST_CODE_ALL_MEMBER);
                }
            }
        });
        ...
        mSearch_title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                JChatDemoApplication.mSearchGroup = mMemberInfoList;
                startActivity(intent);
            }
        });
