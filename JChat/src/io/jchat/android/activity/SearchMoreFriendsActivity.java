...
public class SearchMoreFriendsActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (selectObject instanceof UserInfo) {
            ...
            if (isForwardMsg) {
                ...
                intent.putExtra(JChatDemoApplication.TARGET_ID, friend.getUserName());
                intent.putExtra(JChatDemoApplication.TARGET_APP_KEY, friend.getAppKey());
                intent.putExtra(JChatDemoApplication.CONV_TITLE, notename);
    ...
    private synchronized SearchResult filterInfo(String filterStr) {
        ...
        //所有好友名单
        List<UserInfo> mFriendInfoList = JChatDemoApplication.mFriendInfoList;
