...
import io.jchat.android.adapter.MapPickerAdapter;
import io.jchat.android.application.JChatDemoApplication;
import io.jchat.android.chatting.utils.BitmapLoader;
import io.jchat.android.entity.LocationService;

import static io.jchat.android.application.JChatDemoApplication.context;
...
public class MapPickerActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    private ImageView mLocationSend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationService = JChatDemoApplication.locationService;
        ...
        mLocationBack = (ImageView) findViewById(R.id.locationBack);
        mLocationSend = (ImageView) findViewById(R.id.locationSend);
    ...
    private void initIntent() {
        ...
        mLocationSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MapPickerActivity.this, "发送地理", Toast.LENGTH_SHORT).show();
        ...
        mLocationBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onBackPressed();
            }
