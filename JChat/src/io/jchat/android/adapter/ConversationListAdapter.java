...
import io.jchat.android.view.SwipeLayoutConv;
            ...
            if (lastMsg != null) {
                ...
                switch (lastMsg.getContentType()) {
                    ...
                    case eventNotification:
                        EventNotificationContent.EventNotificationType type = ((EventNotificationContent) lastMsg
                                .getContent()).getEventNotificationType();
                        if (type == EventNotificationContent.EventNotificationType.group_info_updated) {
                            contentStr = "[群信息变动]";
                        } else {
                ...
                if (mAtAll.get(position) && JChatDemoApplication.isAtall.get(gid) != null && JChatDemoApplication.isAtall.get(gid)) {
                ...
                } else if (mArray.get(position) && JChatDemoApplication.isAtMe.get(gid) != null && JChatDemoApplication.isAtMe.get(gid)) {
                    //有人@我 文字提示
                    ...
                    if (lastMsg.getTargetType() == ConversationType.group && !contentStr.equals("[群成员变动]")) {
                        ...
                        if (JChatDemoApplication.isAtall.get(gid) != null && JChatDemoApplication.isAtall.get(gid)) {
                            content.setText("[@所有人] " + fromName + ": " + contentStr);
                        } else if (JChatDemoApplication.isAtMe.get(gid) != null && JChatDemoApplication.isAtMe.get(gid)) {
