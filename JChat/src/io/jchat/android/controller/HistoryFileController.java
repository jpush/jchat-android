...
import io.jchat.android.activity.HistoryFileActivity;
import io.jchat.android.activity.fragment.AudioFileFragment;
import io.jchat.android.activity.fragment.DocumentFileFragment;
import io.jchat.android.activity.fragment.ImageFileFragment;
import io.jchat.android.activity.fragment.OtherFileFragment;
import io.jchat.android.activity.fragment.VideoFileFragment;
import io.jchat.android.adapter.ViewPagerAdapter;
import io.jchat.android.application.JChatDemoApplication;
import io.jchat.android.model.SelectedHistoryFileListener;
import io.jchat.android.view.HistoryFileView;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.delete_file_btn:
                ...
                JChatDemoApplication.ids.clear();
                for (Integer id : idMap.keySet()) {
                    //把即将被删除的消息添加进集合中,注意获取message的id是从map中拿出来的.
                    JChatDemoApplication.ids.add(conversation.getMessage(idMap.get(id)));
